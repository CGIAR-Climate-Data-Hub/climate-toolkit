"""Crop-calendar package API.

Expose stable crop-calendar helpers lazily so importers do not pay GGCMI asset
and registry import costs unless they actually use them.
"""
