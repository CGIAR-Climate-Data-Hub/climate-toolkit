...
import json
import argparse
from climate_toolkit._resources import load_json_resource
...
from climate_toolkit.crop_calendar.registry import (
    normalize_crop_name,
...
CROP_WATER_BALANCE_PARAMS_PACKAGE = "climate_toolkit.calculate_hazards"
...
def _fetch_soil_grid_snapshot(lat: float, lon: float) -> Dict[str, Any]:
    ...
    from climate_toolkit.fetch_data.source_data.sources.utils.models import SoilVariable
...
def calculate_hazards(
    ...
    livestock_type : str, default 'cattle_dairy'
        ...
        ``climate_toolkit.climatology.heat_stress.list_thi_livestock_profiles``
        for the full list.
...
# python -m climate_toolkit.calculate_hazards.hazards maize --location="-1.286,36.817" --date-from 2016-01-01 --date-to 2016-12-31 --season-start 2016-03-01 --season-end 2016-06-30

# Fixed single season:
# python -m climate_toolkit.calculate_hazards.hazards maize --location="-1.286,36.817" --date-from 2018-01-01 --date-to 2022-12-31 --fixed-season "03-01:06-30" --source era_5

# Fixed two seasons:
# python -m climate_toolkit.calculate_hazards.hazards beans --location="-1.286,36.817" --date-from 2018-01-01 --date-to 2022-12-31 --fixed-season "03-01:05-31,10-01:12-15" --source agera_5

# Fixed year-crossing season:
# python -m climate_toolkit.calculate_hazards.hazards sorghum --location="-1.286,36.817" --date-from 2012-01-01 --date-to 2016-12-31 --fixed-season "11-01:02-28" --source chirps_v2+chirts

# Explicit season dates (single season):
# python -m climate_toolkit.calculate_hazards.hazards maize --location="-1.286,36.817" --date-from 2020-01-01 --date-to 2020-12-31 --season-start 2020-03-01 --season-end 2020-06-30

# JSON output to file:
# python -m climate_toolkit.calculate_hazards.hazards rice --location="-1.286,36.817" --date-from 2019-01-01 --date-to 2021-12-31 --fixed-season "04-15:07-10" --source auto --format json --output results.json
