...
from climate_toolkit.crop_calendar.ggcmi import CALENDAR_SYSTEM_CHOICES
...
def compare(
    ...
    livestock_type : str, optional
        ...
        ``'cattle_general'``. See
        :func:`climate_toolkit.climatology.heat_stress.list_thi_livestock_profiles`
        for the full list.
...
# python -m climate_toolkit.compare_periods.periods --location=-1.286,36.817 --baseline-start=1991 --baseline-end=2016 --focal-year=2015 --source=chirps_v2+chirts --output=results/nairobi_2015_vs_1991-2016_auto.json

# Single fixed season:
# python -m climate_toolkit.compare_periods.periods --location=-1.286,36.817 --baseline-start=1991 --baseline-end=2020 --focal-year=2019 --source=terraclimate --fixed-season=03-01:05-31 --output=results/nairobi_2019_MAM.json

# Two fixed seasons:
# python -m climate_toolkit.compare_periods.periods --location=-1.286,36.817 --baseline-start=1991 --baseline-end=2020 --focal-year=2019 --source=era_5 --fixed-season='03-01:05-31,10-01:12-15' --output=results/nairobi_2019_MAM_OND.json

# Year-crossing single window:
# python -m climate_toolkit.compare_periods.periods --location=-1.286,36.817 --baseline-start=1991 --baseline-end=2016 --focal-year=2016 --source=chirps_v2 --fixed-season=11-01:02-28 --output=results/nairobi_2016_NDJF.json
