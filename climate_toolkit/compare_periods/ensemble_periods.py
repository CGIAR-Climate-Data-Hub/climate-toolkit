...
from climate_toolkit.compare_periods.periods import (
...
from climate_toolkit.crop_calendar.ggcmi import CALENDAR_SYSTEM_CHOICES, resolve_calendar_preset
...
# python -m climate_toolkit.compare_periods.ensemble_periods --list-models

# focal year from external observed source:
# python -m climate_toolkit.compare_periods.ensemble_periods --location="-1.286,36.817" --baseline-start 1991 --baseline-end 2020 --future-start 2040 --future-end 2060 --fixed-season "03-01:05-31" --scenarios ssp245 --focal-year 2019 --focal-source era_5 --output ensemble_mam_focal2019.json
# focal year from NEX-GDDP:
# python -m climate_toolkit.compare_periods.ensemble_periods --location="-1.286,36.817" --baseline-start 1991 --baseline-end 2020 --future-start 2040 --future-end 2060 --fixed-season "03-01:05-31" --scenarios ssp245 --focal-year 2019 --output ensemble_mam_focal2019.json

# Auto-detected season (no --fixed-season) -- all models, pick scenarios:
# python -m climate_toolkit.compare_periods.ensemble_periods --location="-1.286,36.817" --baseline-start 1991 --baseline-end 2020 --future-start 2040 --future-end 2060 --scenarios ssp245,ssp585 --output ensemble_auto_all.json
# python -m climate_toolkit.compare_periods.ensemble_periods --location="-1.286,36.817" --baseline-start 1991 --baseline-end 2020 --future-start 2040 --future-end 2060 --models "ACCESS-CM2,EC-Earth3,MRI-ESM2-0" --scenarios ssp245,ssp585 --output ensemble_auto.json

# Fixed single season:
# python -m climate_toolkit.compare_periods.ensemble_periods --location="-1.286,36.817" --baseline-start 1991 --baseline-end 2020 --future-start 2040 --future-end 2060 --fixed-season "03-01:05-31" --scenarios ssp245,ssp585 --output ensemble_mam_all.json
# python -m climate_toolkit.compare_periods.ensemble_periods --location="-1.286,36.817" --baseline-start 1991 --baseline-end 2020 --future-start 2040 --future-end 2060 --fixed-season "03-01:05-31" --models "ACCESS-CM2,EC-Earth3,MRI-ESM2-0" --scenarios ssp585 --output ensemble_mam.json

# Fixed two seasons:
# python -m climate_toolkit.compare_periods.ensemble_periods --location="-1.286,36.817" --baseline-start 1991 --baseline-end 2020 --future-start 2040 --future-end 2060 --fixed-season "03-01:05-31,10-01:12-15" --scenarios ssp245,ssp585 --output ensemble_mam_ond_all.json
# python -m climate_toolkit.compare_periods.ensemble_periods --location="-1.286,36.817" --baseline-start 1991 --baseline-end 2020 --future-start 2040 --future-end 2060 --fixed-season "03-01:05-31,10-01:12-15" --models "ACCESS-CM2,EC-Earth3,MRI-ESM2-0" --scenarios ssp245,ssp585 --output ensemble_mam_ond.json

# Fixed year-crossing season:
# python -m climate_toolkit.compare_periods.ensemble_periods --location="-1.286,36.817" --baseline-start 1991 --baseline-end 2020 --future-start 2040 --future-end 2060 --fixed-season "11-01:02-28" --scenarios ssp245,ssp585 --output ensemble_njf_all.json
# python -m climate_toolkit.compare_periods.ensemble_periods --location="-1.286,36.817" --baseline-start 1991 --baseline-end 2020 --future-start 2040 --future-end 2060 --fixed-season "11-01:02-28" --models "ACCESS-CM2,EC-Earth3,MRI-ESM2-0" --scenarios ssp585 --output ensemble_njf.json
