"""Download daily weather-station observations from NOAA GHCN-Daily."""
...
from climate_toolkit.weather_station.ghcn_daily import fetch_ghcn_daily_records
...
class DownloadData(models.DataDownloadBase):
    ...
    def download_variables(self) -> pd.DataFrame:
        ...
        if df.empty and self.verbose:
            logger.warning("No GHCN-Daily rows returned for requested station window.")
        return df
