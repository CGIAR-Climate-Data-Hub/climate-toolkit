...
`climate-toolkit-fetch` or `climate_toolkit.fetch_data.fetch_data`.
"""
...
# python .\climate_toolkit\fetch_data\source_data\source_data.py --source nex_gddp --variables precipitation,max_temperature,min_temperature --from 2050-01-01 --to 2050-01-10 --lon 36.817 --lat -1.286 --model GFDL-ESM4 --scenario ssp245

# For other sources
# python .\climate_toolkit\fetch_data\source_data\source_data.py --source chirps_v2 --variables precipitation,max_temperature,min_temperature,soil_moisture,bulk_density,wind_speed,solar_radiation,humidity,ph,silt_content,clay_content --from 2020-01-01 --to 2020-01-10 --lon 36.817 --lat -1.286

# Download data in csv
# For nex_gddp with different models and scenarios
# python .\climate_toolkit\fetch_data\source_data\source_data.py --source nex_gddp --variables precipitation,max_temperature,min_temperature --from 2050-01-01 --to 2050-01-10 --lon 36.817 --lat -1.286 --model GFDL-ESM4 --scenario ssp245 --format csv --output nexgddp_2050.csv

# For other sources
# python .\climate_toolkit\fetch_data\source_data\source_data.py --source chirts --variables precipitation,max_temperature,min_temperature --from 2016-01-01 --to 2016-01-10 --lon 36.817 --lat -1.286 --format csv --output chirts_2016.csv
