...
# python climate_toolkit/fetch_data/preprocess_data/preprocess_data.py --source era_5 --lon 36.8 --lat -1.3 --start 2020-01-01 --end 2020-03-05

# python climate_toolkit/fetch_data/preprocess_data/preprocess_data.py --source nex_gddp --lon 36.8 --lat -1.3 --start 2020-01-01 --end 2020-08-31 --model MRI-ESM2-0 --scenario ssp585

# Download data in csv
# For NEX_GDDP
# python climate_toolkit/fetch_data/preprocess_data/preprocess_data.py --source nex_gddp --lon 36.8 --lat -1.3 --start 2020-01-01 --end 2020-08-31 --model MRI-ESM2-0 --scenario ssp585 --format csv --output nex_gddp_preprocessed_jan-aug_2020.csv

# For other sources
# python climate_toolkit/fetch_data/preprocess_data/preprocess_data.py --source era_5 --lon 36.8 --lat -1.3 --start 2020-01-01 --end 2020-03-05 --format csv --output era5_preprocessed.csv
