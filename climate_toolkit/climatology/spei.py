...
def _daily_with_et0(
    ...
    from climate_toolkit.season_analysis.seasons import add_et0
...
# Use:
# python -m climate_toolkit.climatology.spei --location "-1.286,36.817" --source agera_5 --start 2020-01-01 --end 2020-12-31 --index spei --scale-months 12
