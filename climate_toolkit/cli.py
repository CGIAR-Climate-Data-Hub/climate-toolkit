...
COMMANDS = {
    "gee-check": "climate_toolkit.gee_check:main",
    "fetch": "climate_toolkit.fetch_data.fetch_data:main",
    "seasons": "climate_toolkit.season_analysis.seasons:main",
    "seasons-ensemble": "climate_toolkit.season_analysis.ensemble:main",
    "stats": "climate_toolkit.climate_statistics.statistics:main",
    "stats-ensemble": "climate_toolkit.climate_statistics.ensemble_statistics:main",
    "periods": "climate_toolkit.compare_periods.periods:main",
    "periods-ensemble": "climate_toolkit.compare_periods.ensemble_periods:main",
    "hazards": "climate_toolkit.calculate_hazards.hazards:main",
    "hazards-ensemble": "climate_toolkit.calculate_hazards.ensemble_hazards:main",
    "weather-station-download": "climate_toolkit.weather_station.download:main",
    "weather-station-compare": "climate_toolkit.weather_station.compare:main",
    "compare-datasets": "climate_toolkit.compare_datasets.compare_datasets:main",
    "climatology": "climate_toolkit.climatology.long_term_climatology:main",
    "spei": "climate_toolkit.climatology.spei:main",
    "xclim-reference": "climate_toolkit.climatology.xclim_reference:main",
}
