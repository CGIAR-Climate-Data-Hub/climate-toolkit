...
- kept fallback to `climate_toolkit...` absolute imports
...
- `import climate_toolkit.calculate_hazards.ensemble_hazards`
...
python3 -m py_compile climate_toolkit/calculate_hazards/ensemble_hazards.py tests/test_ensemble_hazards_import.py
.venv/bin/python - <<'PY'
import importlib
...
```text
module ok climate_toolkit.calculate_hazards.ensemble_hazards
PREPROCESS_AVAILABLE True
HAS_FAY True
```
